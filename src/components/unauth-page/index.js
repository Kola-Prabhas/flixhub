...
const questions = [
	{
		ques: "What is Flixhub?",
		ans: `Flixhub is a streaming service that offers a wide variety of award-winning TV shows, movies, anime, documentaries and more – on thousands of internet-connected devices. You can watch as much as you want, whenever you want, without a single ad – all for one low monthly price. There's always something new to discover, and new TV shows and movies are added every week!`,
	},
	{
		ques: "How much does Flixhub cost",
		ans: `Watch Flixhub on your smartphone, tablet, Smart TV, laptop, or streaming device, all for one fixed monthly fee. Plans range from ₹ 149 to ₹ 649 a month. No extra costs, no contracts.`,
	},
	{
		ques: "What can I watch on Flixhub?",
		ans: `Watch anywhere, anytime. Sign in with your Flixhub account to watch instantly on the web at Flixhub.com from your personal computer or on any internet-connected device that offers the Flixhub app, including smart TVs, smartphones, tablets, streaming media players and game consoles.
    You can also download your favourite shows with the iOS, Android, or Windows 10 app. Use downloads to watch while you're on the go and without an internet connection. Take Flixhub with you anywhere.`,
	},
	{
		ques: "How do I cancel?",
		ans: `Flixhub is flexible. There are no annoying contracts and no commitments. You can easily cancel your account online in two clicks. There are no cancellation fees – start or stop your account anytime.`,
	},
	{
		ques: "What can I watch on Flixhub?",
		ans: `Flixhub has an extensive library of feature films, documentaries, TV shows, anime, award-winning Flixhub originals, and more. Watch as much as you want, anytime you want.`,
	},
	{
		ques: "Is Flixhub good for kids?",
		ans: `The Flixhub Kids experience is included in your membership to give parents control while kids enjoy family-friendly TV shows and films in their own space.
